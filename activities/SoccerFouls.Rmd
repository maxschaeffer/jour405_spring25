...
```{r}
matches |> summarize(coorelation = cor(fouls, goal_diff, method="pearson"))
```
...
There is not much of a relationship between goal differential in a given game and how many fouls a team commits. It is reasonable to conclude from this that the number of fouls is not a primary factor in determining the result of a game.
