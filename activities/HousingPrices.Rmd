...
Data supports local officials claims that house prices have increased after the building of a new local transit system. The average sale price since the construction of the transit has increased by $15,000, indicating a potential succesful effort to increase property values in the city. However, the data does not prove that the transit is the only factor in increasing values as home prices have been increasing nationwide.
