...
These scores fit my pre-conceived notions of private colleges having higher mean and median scores, then publics, then community colleges. The standard deviation as well as min and max also show that the data at the privates is more concentrated around the mean with less variance.
...
1. Yes there is statistically significant difference between these college types, as shown by the extremely small p-values. 
2. All college types differ from each other, with the smallest gap being between private and public colleges, while the biggest is between privates and community colleges. The smallest p-value is .000021 which is still very small, showing all the differences to be significant.
3. The differences are all relatively large.

Headline: Private Colleges continue to admit students with the Highest SAT Scores

American colleges demonstrate a significant difference in the SAT scores of their accepted students, according to a recent statistical analysis.

Private colleges are at the top of the heap, admitting students with an average SAT score of 1435, while community colleges average score was just below 1070. Public universities served as a middle ground, but were closer to the private universities than any other gap. 
