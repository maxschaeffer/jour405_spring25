...
At first glance it looks like people generally expected the scores to be higher than they were in reality with a higher expected frequency of five star ratings and a lower expected frequency of 1 and 2 star ratings then there was in reality.
...
We should reject the null hypothesis in this scenario, because the chi-square value is above our critical value. Thus this demonstrates that there is a statistically significant difference between what we expected and what we got. 
