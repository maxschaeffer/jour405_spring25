...
It means the respondent's with the lower weight are respondents that are a part of a more common subgroup, and potentially overrepresented in the survey, the oppostie is true for those with the higher rate,
...
The rarely/never category of voters.
2. How might these differences affect reporting on likely voter turnout?
It might lead to an overestimation of the amount of people who typically don't vote that will vote.
...
I think these differences exist because people who are less likely to vote are likely harder to reach for these kind of surveys so they were under-represented. Therefore the weighted data gives them more signifcance. 
