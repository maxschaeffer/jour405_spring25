...
Yes it is a useful model because the F-Statistic in combination with the P-Value suggests that it is. It will not be perfect, but it will be worth examining.
...
Points scored is the most impactful toward wining, which makes sense because it is diffuicult to win games without an offense. Yards gained seems to matter the least, but it is correlated with scoring a lot of points so it kind of indirectly can lead to wins.
...
If you were discussing the Eagles you could say the Eagles ability to have high offensive outputs was the most directly responsible for their Super Bowl run in 2025. Even when Philadelphia was outgained, they found ways to put up points either through their defense or high red zone efficiency.
