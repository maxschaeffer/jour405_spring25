...
```{r}
aces_percentile <- team_aces |> mutate(percentile = ntile(total_aces, 100))
```
...
Interestingly, Maryland is much higher in percentile than the powerhouses of its conference, Nebraska and Wisconsin. As a sports journalist, I would want to write about whether the ace is an overvalued asset on a team, whether Maryland didn't push the advantage well enough, or how bad it is in other categories that it can't compete despite being elite in this category. 
