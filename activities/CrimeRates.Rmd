...
crimes_with_rates <- crimes |> mutate(property_rate = property_crime_total/population * 10000)
```
...
I was very interested to find out that crime in total has dropped so much over the years, especially because I have had many experiences over recent years where people feel like our area is getting so much more dangerous. I have usually argued that social media and these people who put a tweet out for every sensational crime creates that feeling in people, but it's not actually accurate. I feel like this data has validated that argument for me.
