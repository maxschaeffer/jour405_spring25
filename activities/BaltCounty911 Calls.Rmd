...
If I had to draw horizontal lines to isolate the outlier days, I would draw the upper line at around 16 and the lower line at 5. I don't see many clear patterns in terms of which days have more or less calls, it seems often times after an outlier day it goes back to a more normal value or flips completely.
...
They are close to where I would have put my lines on task 3, but I tried to include a bit too many numbers.The true outliers are less common than what I had in mind.
...
Tuesday featured an extremely high volume of 911 calls for drug overdoses in Baltimore county, with 23 calls, more than double the expected number on an average Tuesday.
...
I would like to look more into the seasonal patterns. There is statistically significant differences between winter and summer and certain months and I think there must be some explanation for that. I would tell my editor I want to talk to detectives who investigate the drug trade to see if there is a reason it slows down during that month or drugs are for some reason safer. Additionally, the statistical outlier days would be interesting to report on to see if you can track some sort of bad package that came into the community, and the potential source of it. It would be a difficult topic to pursue since most people working in the drug trades or abusing drugs aren't looking to talk to journalists about it, but I think some really interesting stories could come out of it.
