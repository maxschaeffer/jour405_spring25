...
There is a very strong positive correlation between the two variables. The scatterplot demonstrates this correlation and demonstrates that there are almost no outliers where the DJIA is very low, but the GDP is high or vice versa.  
