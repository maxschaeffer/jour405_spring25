...
1. The 95% confidence interval shows that there is 95^ confident that the mean is within th interval.
2. Figures within the interval or within a standard deviation of the mean.
3. PG County car thefts trending downward
...
I think we can reject the null hypothesis, because there is a significant difference between the two periods.
...
I don't think I'd change my headline. I would just inform my editor that there's a chance that the number will go back up and the story will need context. I would expect her to ask about the source of the data as well as the methodology behind the data colleciton and the analysis.
