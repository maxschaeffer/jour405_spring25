...
The results suggest that the spike year wasn't a singular outlier after which the rate returned to normal or close to normal. The rate went way up during the spike, but has remained closer to the spike year than the pre-spike mean since. In the grand scheme of things this suggests that the spike had lasting consequences on the safety of people's vehicles.
...
This chart recontextualizes the data slightly for me by showing that although thefts have remained high as I just described above, they are consistenyl declining, suggesting that within a year or two they could be a lot closer to the pre-spike rate. 
My new title. would be: PG County car thefts before and after massive spike in 2023.
...
- **Null Hypothesis (H0)**: The spike in car thefts in 2023 and thereafter was a coincidence and not statistically significant.

- **Alternative Hypothesis (H1)**: The spike in car thefts in 2023 was a statistically significant data point that was not typical coincidental variance in the data.
...
This shows that our result is absolutely significant and there are large real differences in our average rates because our P-Value is almost zero and our F Value is quite large. This ANOVA test would support rejecting our null hypothesis.
...
The tukey test shows that there are significant differences between all three time periods. The largest is obviously between pre-spike and our spike year, but the difference between pre-spike and post-spike (for now) is statistically significant as well. 

Headline:Prince George's County car thefts are down from record 2023, but still high

Lede: After 2023 featured a record rate of Car Thefts in Prince George's County, Maryland, residents will be happy to know there vehicles were safer in 2024, but only marginally.
Despite dropping, the rates still remained significantly higher than they were before the massive spike in 2023.
