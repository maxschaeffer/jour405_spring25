...
Yes they have improved because you can see that every single score is above the previous mean.
...
The mean score is higher with a lower standard deviation. These indicate that the program is succeeding and potentially that there needs to be a larger sample size with the small standard deviatio. 
...
Potential improvement in test scores after new program's implementation.
...
This p-value is extremely small which indicates that our result is more than likely statistically significant although it is not hard proof. I would say that there is data analysis of 12 classrooms that provides validity to the claim that the new program is improving test scores.
...
Headline: Superintendent's new reading program sees success.
Lead: After the county superintendent implemented a new reading curriculum for students, the average reading test score jumped by over three points. A data analysis of 12 randomly-selected classrooms supports that the curriculum is helping to increase the scores.



### Reflection Question 6:
What metrics or outcomes beyond test scores might be important to track for assessing reading performance?
Student's grades in reading/language arts classes, amount/difficulty level of books being checked out of the library
