---
title: "Chi-SquareGradeDistribution"
...
My initial impression/guess is that the differences between the expected and observed frequencies are meaningful. 400 is not a very large sample size in the grand scheme of things so the fact that the differences between the expected and observed frequencies as high as 20 feels like a significant number.
...
Yes we do. According to my calculations are chi-square statistic is 11.667 which is greatter than our critical value of 9.488.
...
There were more students at the far-ends of the spectrum than expected in terms of As and Fs and less at the "average" or C mark. I would want to ask the instructor/college what they think is allowing a higher percentage of students to exceed then expected? Conversely, I would ask why they believe more students than expected are failing and what they feel needs to be done to bring these students in the fold>
