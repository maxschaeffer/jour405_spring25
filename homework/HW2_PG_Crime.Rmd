...
I'd argue that homicide is always going to be the most important category because it is the most severe and dangerous crime that citizens want to know about. I also feel that the difference in types of thefts can make summarizing the data slightly more challenging because, you don't know which things to put under the general umbrella of theft and which not to. Or for the categories like "Auto Stolen vs. Auto Stolen & Recovered" you don't know if the car stolen is being counted twice if it was recoverd, or if it's a distinct category.
...
The first thing that jumped out to me about the data is that all the highest categories of crimes are related to motor vehicles in one way or another. Generally, violent crimes were on the lower end of the monthly averages which I would expect is typical given that these are the crimes for which the consequences are most severe. The pattern of high car theft makes me feel like PG County has an issue with security around vehicles, and people feel like cars there are easy targets for robbery and theft. If I were working on a story I would want to ask police what efforts they're making to combat the car theft issues.
...
A couple crimes were up for all three months of the summer: homicide, stolen autos and thefts from autos. Mostly though the numbers seem random with crime up in July and then down in august or vice versa. I would say overall there is not enough of a trend showing that crime goes up in the summer for it to be a significant aspect of any news story on this data.
...
When parking in Prince George's county, you would be wise to triple check that your car is locked and consider a lock on your steering wheel.

Crime date from the county's police department makes it clear that crimes involving vehicles are the most common violations of the law in the DC Suburb.Vehicle accidents, stolen cars, and thefts from cars are all occuring over 390 times per month on average.

-Quote from police on the issue-
